...
const SCHEMA: Integration = {
  ...
  description:
    "With the Veracode datasource, you can connect and query for application and scan result information from Veracode SaaS.",
  friendlyName: "Veracode",
  type: "API",
  datasource: {
    url: {
      type: DatasourceFieldType.STRING,
...
class GithubIntegration implements IntegrationBase {
